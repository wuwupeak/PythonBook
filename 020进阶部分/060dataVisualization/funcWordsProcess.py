...
def fileWordsCountForEN(fileName):
        '''
        该函数对四个函数进行了封装
        1.fileRead
        2.fileClean
        ...
        wordsClean = fileClean(fileContent)
        wordsUnique = fileWordsUnique(wordsClean)
        wordsCountDict = fileWordsCount(wordsClean,wordsUnique)
        return wordsCountDict