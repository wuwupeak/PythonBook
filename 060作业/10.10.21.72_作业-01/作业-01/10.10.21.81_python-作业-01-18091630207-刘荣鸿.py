...
# 要处理的文本
txt = "When the aerials are down, and your spirit is covered with snows of cynicism and the ice of pessimism, then you are grown old, even at twenty, but as long as your aerials are up, to catch the waves of optimism, there is hope you may die young at eighty."
# 字符转换
txt = txt.replace(",","")
txt = txt.replace(".","")
...
print("这段话总共有{}个单词。".format(length))
