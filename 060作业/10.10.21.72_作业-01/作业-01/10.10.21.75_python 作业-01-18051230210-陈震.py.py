...
# 输出格式为"这段话总共有**个单词。"
valueString = "When the aerials are down, and your spirit is covered with snows of cynicism and 
the ice of pessimism, then you are grown old, even at twenty, but as long as your aerials 
are up, to catch the waves of optimism, there is hope you may die young at eighty."
...
for word in words:
    if word not in wordsUnique:
        ...
        wordsCount0 = words.Count(word)
        wordsCount.append(wordsCount0)
print(wordsUnique)
print(wordsCount) 
print("wordsUnique" + "在文章中出现的次数是" + "wordsCount")
