...
wordName = "When the aerials are down, and your spirit is covered with snows of cynicism and the ice of pessimism, then you are grown old, even at twenty, but as long as your aerialsare up, to catch the waves of optimism, there is hope you may die young at eighty."
wordList = wordCount.split()
wordUniqueList = []
for word in wordlist:
    if word not in newwordUniqueList:
        newwordUniqueList.append(word)
newwordNumber2 = len(newwordUniqueList)
print("这段话总共有" + str(newwordNumber2) + "个独一无二的单词")
