...
# 输出格式为"这段话总共有**个单词。
words = "When the aerials are down, and your spirit is covered with snows of cynicism and the ice of pessimism, then you are grown old, even at twenty, but as long as your aerials aup, to catch the waves of optimism, there is hope you may die young at eighty."
wordlist = words.split()
for Index in range(len(wordlist)):
print("这段话共有" + str(wordNumber) + "个单词。")
